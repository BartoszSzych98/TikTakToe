...
public class EndGameWindow {
    ...
    public EndGameWindow(){
        ...
        nextGame = new Button("Next challenge");
    ...
    public void xWon(boolean vsComputer){
        if (vsComputer) {
            label.setText("Congratulations Player won!!!");
        } else {
            label.setText("Congratulations Player X won!!!");
        }
    ...
    public void oWon(boolean vsComputer){
        if (vsComputer) {
            label.setText("Congratulations C-3PO won!!!");
        } else {
            label.setText("Congratulations Player O won!!!");
        }
        stage.setScene(scene);
        stage.show();
    }
