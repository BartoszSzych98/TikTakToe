...
public class Board {
    ...
    public Board (Controller controller, InfoPanel infoPanel) {
        ...
        vsComputer = new Button("Player vs C-3PO");
        ...
        ranking = new Button("List of Gods");
    ...
    public void startGameWithComputer(){
        ...
        if (random.nextInt(2) == 0) {
            infoPanel.updateLabel("Player now");
            controller.setPlayerX(true);
        } else {
            infoPanel.updateLabel("C-3PO now");
    ...
    public void startNewGame() {
        ...
        if (random.nextInt(2) == 0) {
            infoPanel.updateLabel("Player X now");
            controller.setPlayerX(true);
        } else {
            infoPanel.updateLabel("Player O now");
            controller.setPlayerX(false);
            controller.setGameEnd(false);
        }
    }
